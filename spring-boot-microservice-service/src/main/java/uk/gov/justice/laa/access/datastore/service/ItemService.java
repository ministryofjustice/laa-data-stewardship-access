...
//import uk.gov.justice.laa.springboot.microservice.exception.ApplicationNotFoundException;
...
//        .findById(id)
//        .orElseThrow(
//            () -> new ApplicationNotFoundException(String.format("No item found with id: %s", id)));
//  }
//}
