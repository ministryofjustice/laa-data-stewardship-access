...
//
//    assertThrows(ApplicationNotFoundException.class, () -> itemService.getItem(id));
//
...
//
//    assertThrows(
//        ApplicationNotFoundException.class, () -> itemService.updateItem(id, itemRequestBody));
//
...
//    when(mockItemRepository.findById(id)).thenReturn(Optional.empty());
//
//    assertThrows(ApplicationNotFoundException.class, () -> itemService.deleteItem(id));
//
